  ...
  return (
    <div className="main-body body">
      <header className="masthead">
        <img
          src=".//img/sigai-header-banner.jpeg"
          className="masthead-background-img"
              ...
              <div className="row mt-4">
                <div className="col-lg-8">
                  <iframe
                    width="100%"
                    height="300px"
                    src={`https://www.google.com/maps/embed/v1/place?key=${GCLOUD_API_KEY}&q=${encodeURIComponent(
                      "Olsson+Hall/@38.032088,-78.5132753,17z/data=!3m1!4b1!4m6!3m5!1s0x89b3865b43b6ada7:0x1861384e69939c07!8m2!3d38.032088!4d-78.510695!16s%2Fg%2F11bwhbd54d!5m1!1e2?entry=ttu&g_ep=EgoyMDI1MDEwOC4wIKXMDSoASAFQAw%3D%3D"
                    )}`}
                  ></iframe>{" "}
                </div>
                <div className="row">
