...
// const res = await fetch(`http://127.0.0.1:8000/api/search?q=hi`, {
//   method: "GET",
// });
// if (!res.ok) throw new Error("API failed");
// const data = await res.json();
// const GCLOUD_API_KEY = data;
console.log("GCloud API: " + GCLOUD_API_KEY);
...
function Projects() {
  ...
  return (
    <section id="projects" className="body py-5">
